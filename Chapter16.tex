...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item When bromine adds to benzene, a catalyst such as \textbf{\ce{FeBr3}} is needed.
    ...
    \begin{enumerate}
        ...
        \item Reactivity: Cyclobutadiene is so reactive that it dimerizes before it can be isolated. Cyclooctatetraene adds \ce{Br2} readily to the double bonds.
...
\begin{example} %16-14
    When 3-chlorocyclopropene is treated with \ce{AgBF4}, \ce{AgCl} precipitates. The organic product can be obtained as a crystalline material, soluble in polar solvents such as nitromethane but insoluble in hexane. When the crystalline material is dissolved in nitromethane containing \ce{KCl}, the original 3-chlorocyclopropene is regenerated. Determine the structure of the crystalline material, and write equations for its formation and its reaction with chloride ion.
\end{example}
...
\begin{example} %16-20 硼嗪
    Borazole, \ce{B3N3H6}, is an unusually stable cyclic compound. Propose a structure for borazole, and explain why it is aromatic.
\end{example}
