...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Lithium tri-tert-butoxyaluminum hydride, \ch{LiAlH(O-\textit{t}-Bu)3} is a weaker reducing agent than lithium aluminum hydride. 
